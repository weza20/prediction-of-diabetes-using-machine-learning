...
st.write(
    "*A logbook for remind u to take your medicine ,any medication notes by sending daily notification at the time ")
...
st.write("_ creating a Machine Learning methodology that can detect diabetes in easy way with high accuracy ")
st.write(
